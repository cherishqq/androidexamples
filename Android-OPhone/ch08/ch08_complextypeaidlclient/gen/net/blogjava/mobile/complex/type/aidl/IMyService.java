 ...
 * Original file: E:\\mystudio\\java\\android_workspace\\ch08_complextypeaidlclient\\src\\net\\blogjava\\mobile\\complex\\type\\aidl\\IMyService.aidl
 */
...
net.blogjava.mobile.complex.type.aidl.Product _arg1;
if ((0!=data.readInt())) {
_arg1 = net.blogjava.mobile.complex.type.aidl.Product.CREATOR.createFromParcel(data);
}
else {
_arg1 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
net.blogjava.mobile.complex.type.aidl.Product _result = this.getProduct();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
public java.util.Map getMap(java.lang.String country, net.blogjava.mobile.complex.type.aidl.Product product) throws android.os.RemoteException
{
...
public net.blogjava.mobile.complex.type.aidl.Product getProduct() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
net.blogjava.mobile.complex.type.aidl.Product _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getProduct, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = net.blogjava.mobile.complex.type.aidl.Product.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
